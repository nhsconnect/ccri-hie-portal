...
export class FhirService {
  ...
  public getEDMSUrl(): string {
    console.log('getEDMSUkl');
    console.log(this.edmsUrl);
    return this.edmsUrl;
  }
  ...
  public getEDMS(search: string): Observable<fhir.Bundle> {

    console.log('in getEDMS');
    const url: string = this.getEDMSUrl() + search;
    let headers = new HttpHeaders();
